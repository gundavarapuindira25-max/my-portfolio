...
const COMMANDS = {
  ...
  whoami: () => [
    ...
    { t: 'output',  v: 'Fun fact  : shipped 2 LLM-powered apps 🤖' },
  ],
  'ls projects': () => [
    ...
    { t: 'purple',  v: '<span style="color:var(--purple)">drwxr-xr-x</span>  MarketPulse     <span style="color:var(--muted)">// Live Order Book · LLM Narrator</span>' },
    { t: 'purple',  v: '<span style="color:var(--purple)">drwxr-xr-x</span>  MeetingNotes    <span style="color:var(--muted)">// LLM Summarizer · Verified Output</span>' },
  ],
  'cat skills.txt': () => [
    { t: 'info',    v: '── Languages ──' },
  ...
  'cat llm.txt': () => [
    { t: 'success', v: '🤖 LLM Projects — Status: SHIPPED' },
    { t: 'info',    v: '──────────────────────────────────' },
    { t: 'output',  v: '[✓] MarketPulse — live market narrator (Ollama)' },
    { t: 'output',  v: '[✓]   → numeric grounding check before broadcast' },
    { t: 'output',  v: '[✓] Meeting Notes — structured summarizer (Ollama)' },
    { t: 'output',  v: '[✓]   → schema-constrained + 2-layer claim verification' },
    { t: 'info',    v: '──────────────────────────────────' },
    { t: 'success', v: 'Both running on local models — no API key. ✦' },
  ],
